// API information.
const apiUrl = 'https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=bde2c517a532350d2112e613086e8ee8&page=1';
const IMGPATH = "https://image.tmdb.org/t/p/w1280";
const SEARCHAPI =
    "https://api.themoviedb.org/3/search/movie?&api_key=bde2c517a532350d2112e613086e8ee8&query=";
...
function showMovies(url){
    ...
    data.results.forEach(element => {
      // Creating elemnts for our data inside the main tag. 
        ...
        //const text = document.createElement('Get details');
